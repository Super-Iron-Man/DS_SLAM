...
template <int mode>
void AccumulatedTopHessianSSE::AddPoint(EFPoint *p, EnergyFunction const *const ef, int tid) // 0 = active, 1 = linearized, 2=marginalize
{
...
template void AccumulatedTopHessianSSE::AddPoint<0>(EFPoint *p, EnergyFunction const *const ef, int tid);
template void AccumulatedTopHessianSSE::AddPoint<1>(EFPoint *p, EnergyFunction const *const ef, int tid);
template void AccumulatedTopHessianSSE::AddPoint<2>(EFPoint *p, EnergyFunction const *const ef, int tid);

void AccumulatedTopHessianSSE::StitchDouble(MatXX &H, VecX &b, EnergyFunction const *const EF, bool usePrior, bool useDelta, int tid)
{
...
void AccumulatedTopHessianSSE::StitchDoubleInternal(MatXX *H, VecX *b, EnergyFunction const *const EF, bool usePrior,
