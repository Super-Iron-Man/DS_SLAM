...
void AccumulatedSCHessianSSE::StitchDoubleInternal(MatXX *H, VecX *b, EnergyFunction const *const EF,
...
void AccumulatedSCHessianSSE::StitchDouble(MatXX &H, VecX &b, EnergyFunction const *const EF, int tid)
{
